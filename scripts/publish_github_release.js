...
const RELEASE_NAME = 'OMPC Ballistic AeroData v1.1.0 (Light Sea Theme & Windows Installer)';
const BODY = `## OMPC Ballistic AeroData v1.1.0

### Highlights & Updates:
* **Brand New Modern Theme**: Fresh light sea blue theme (\`#E2F1F8\`) across all screens.
* **Refreshed App Icon**: Flutter origami bird icon in high resolution.
* **Windows 1-Click Setup**: Dedicated installer (\`OMPC_Ballistic_AeroData_Setup.exe\`) for simple 1-click deployment on any Windows PC.
* **Standalone Executable**: Direct portable executable (\`OMPC_Ballistic_AeroData.exe\`) and portable USB package.
* **Live Web App**: Deployed to [https://ompc-ballistic-aerodata.web.app](https://ompc-ballistic-aerodata.web.app).
