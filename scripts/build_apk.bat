...
if %ERRORLEVEL% equ 0 (
    copy /y "build\app\outputs\flutter-apk\app-release.apk" "C:\Users\user\Desktop\OMPC_Ballistic_AeroData_v1.5.2.apk"
    copy /y "build\app\outputs\flutter-apk\app-release.apk" "C:\Users\user\Desktop\OMPC_Ballistic_AeroData.apk"
    echo [SUCCESS] Copied APK to Desktop: C:\Users\user\Desktop\OMPC_Ballistic_AeroData_v1.5.2.apk
)
