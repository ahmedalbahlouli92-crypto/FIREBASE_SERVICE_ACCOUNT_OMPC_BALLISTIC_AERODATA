...
class _MainShellState extends State<MainShell> {
  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      ...
      // Seed mock records for Lot Acceptance Test
      final fileNameLot = _storageService.getDailyFileName(module: 'Lot Acceptance Test');
      final fileLot = File('$dirPath/$fileNameLot');
      if (!await fileLot.exists()) {
        await _storageService.ensureDailyFileExists(module: 'Lot Acceptance Test');
        
        final mock1 = BallisticRecord(
          timestamp: '${DateTime.now().subtract(const Duration(minutes: 45)).hour}:${DateTime.now().minute.toString().padLeft(2, '0')} AM',
          operators: 'Ahmed Said',
          shift: 'Day',
          caliber: '5.56x45 SS109',
          lotNo: 'LOT-2026-A1',
          produced: 150,
          defects: 2,
          notes: 'Slight pressure variance recorded',
          status: 'Approved',
          testName: 'Waterproof Test',
          pressureBar: '4.8',
          viscosity: '35 cPs',
          testTime: '60 seconds',
          samplingLocation: 'Chamber Alpha',
          mouthSlow: 2,
          mouthFast: 0,
          primerSlow: 1,
          primerFast: 0,
        ...
        final mock2 = BallisticRecord(
          timestamp: '${DateTime.now().subtract(const Duration(minutes: 10)).hour}:${DateTime.now().minute.toString().padLeft(2, '0')} AM',
          operators: 'Ahmed Said',
          shift: 'Day',
          caliber: '7.62x51 M80',
          lotNo: 'LOT-2026-A2',
          produced: 250,
          defects: 0,
          notes: 'Velocity consistent within specifications',
          status: 'Approved',
        ...
        await _storageService.saveRecord(mock1, module: 'Lot Acceptance Test');
        await _storageService.saveRecord(mock2, module: 'Lot Acceptance Test');
      }

      // Seed mock records for Daily Test
      final fileNameDaily = _storageService.getDailyFileName(module: 'Daily Test');
      final fileDaily = File('$dirPath/$fileNameDaily');
      if (!await fileDaily.exists()) {
        await _storageService.ensureDailyFileExists(module: 'Daily Test');
        
        final mock1 = BallisticRecord(
          timestamp: '${DateTime.now().subtract(const Duration(minutes: 30)).hour}:${DateTime.now().minute.toString().padLeft(2, '0')} AM',
          ...
          produced: 120,
          defects: 1,
          notes: 'Waterproof test success',
          status: 'Approved',
          testName: 'Waterproof Test',
          pressureBar: '5.0',
          viscosity: '40 cPs',
          testTime: '90 seconds',
          samplingLocation: 'Chamber Beta',
          mouthSlow: 1,
          mouthFast: 0,
          primerSlow: 0,
          primerFast: 0,
        ...
        await _storageService.saveRecord(mock1, module: 'Daily Test');
      }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(fontSize: 13.0, color: Color(0xFF8E96A3), height: 1.4),
                        ),
                        const SizedBox(height: 20.0),
                        Text(
                          'Target Path:\n$_storagePath',
                          style: const TextStyle(fontSize: 12.0, color: Color(0xFF06B6D4), fontFamily: 'JetBrainsMono'),
                        ),
                        const SizedBox(height: 24.0),
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.manage_accounts_rounded, color: Color(0xFF06B6D4), size: 20.0),
              ),
              const SizedBox(width: 12.0),
              const Expanded(
                child: Text(
          ...
          Wrap(
            ...
            children: [
              ...
              _buildRoleStatChip('Technician', technicianCount, const Color(0xFF06B6D4), Icons.build_circle_rounded),
          ...
          const Text('Assign User Level / Role:', style: TextStyle(color: Color(0xFF8E96A3), fontSize: 11.5, fontWeight: FontWeight.bold)),
          const SizedBox(height: 6.0),
          Container(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: Colors.white.withOpacity(0.2)),
              prefixIcon: const Icon(Icons.badge_outlined, color: Color(0xFF8E96A3), size: 16.0),
              filled: true,
              fillColor: Colors.black.withOpacity(0.2),
              contentPadding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 8.0),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(6.0), borderSide: BorderSide(color: Colors.white.withOpacity(0.06))),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.precision_manufacturing_rounded, color: Color(0xFFF59E0B), size: 20.0),
              ),
              const SizedBox(width: 12.0),
              const Expanded(
                child: Text(
          ...
          _buildAssetCategoryHeader('Weapons (Type & Serial)', Icons.military_tech_rounded, const Color(0xFF6366F1)),
          const SizedBox(height: 8.0),
          Row(
            children: [
              Expanded(
  ...
  Widget _buildAssetItemList({
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (_, __) => const Divider(color: Color(0xFF1F293D), height: 6.0),
        itemBuilder: (context, index) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Select Test to Configure', style: TextStyle(color: Color(0xFF8E96A3), fontSize: 11.5, fontWeight: FontWeight.bold)),
          const SizedBox(height: 6.0),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 4.0),
            decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      ActionChip(
                        avatar: const Icon(Icons.add, size: 14, color: Color(0xFF06B6D4)),
                  ...
                  if (list.isEmpty)
                    ...
                    const Divider(color: Color(0xFF1F293D), height: 14),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            icon: const Icon(Icons.logout, color: Color(0xFFEF4444), size: 16.0),
                            onPressed: () {
                              setState(() {
